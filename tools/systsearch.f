      ...
      implicit none
      character filename_translate*300,filename_rotation*300
      ...
      pi=3.141592654d0
      zwopi=2.0d0*pi
      call getarg(1, filename_rotation )
      call getarg(2, filename_translate)
      
      write (*,'(a11)') '#pivot auto'
      write (*,'(a25)') '#centered receptor: false'
      write (*,'(a23)') '#centered ligands: true'
      open(11,file=filename_rotation)
      read(11,*) ntheta,nrot
      do 593 i=1,ntheta
...
c      write(*,*) theta(i),nphi(i)
  593 continue
      ...
      open(12,file=filename_translate)
      read(12,*) ntrans
